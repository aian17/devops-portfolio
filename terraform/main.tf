...
# ---------- Private S3 bucket for the site ----------
...
# ---------- TLS certificate (DNS validation) ----------
...
resource "aws_cloudfront_distribution" "site" {
  ...
  # A missing object in a private bucket returns 403, so map it to a real 404 page.
